        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form method="POST" action="/login" class="form-login user space-y-4 md:space-y-6">
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" placeholder="masukan email anda" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                </div>
                @error('email')
                ...
                <button type="submit" class="w-full text-white bg-emerald-600 hover:bg-emerald-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-blue-800">Login</button>
            </form>
        </div>
    </div>
</div>
